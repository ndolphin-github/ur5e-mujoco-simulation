...
class PID_ControllerClass(object):
    ...
    def get_output(self, x_trgt=None, x_curr=None, t_curr=None, VERBOSE=False):
        """
            Get control output (convenience method that combines update and out)
        """
        self.update(t_curr=t_curr, x_trgt=x_trgt, x_curr=x_curr, VERBOSE=VERBOSE)
        return self.out()